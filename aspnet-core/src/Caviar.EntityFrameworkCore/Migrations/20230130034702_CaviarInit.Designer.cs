...
{
    [DbContext(typeof(CaviarDbContext))]
    [Migration("20230130034702_CaviarInit")]
    partial class CaviarInit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Caviar.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Caviar.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Caviar.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Caviar.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Caviar.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Caviar.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Caviar.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Caviar.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Caviar.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
